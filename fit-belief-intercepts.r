...
OUTPUT_PATH <- "/data/wgantt/mi/stan_models/belief/random-intercepts";

PREPROCESS_SCRIPT <- file.path(REPO_PATH, "preprocessing/preprocess.r");
MODEL_NAME <- file.path(REPO_PATH, "model.participant.scenario.int.stan");
MODEL_SAVE_PATH <- file.path(OUTPUT_PATH, "belief-ints.rds");
