...
# repo and YOUR output path for the model object
REPO_PATH <- "/home/wgantt/role-anchored-inferences";
OUTPUT_PATH <- "/data/wgantt/mi/stan_models/belief/random-intercepts-index-code";
...
MODEL_SAVE_PATH <- file.path(OUTPUT_PATH, "belief-intercepts-index-code.rds");
